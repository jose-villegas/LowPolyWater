...
public class FlyCamera : MonoBehaviour
{
    ...
    void Update()
    {
            ...
            (rotateOnlyIfMousedown && Input.GetMouseButton(1)))
        {
            ...
            transform.eulerAngles = Vector3.Lerp(transform.eulerAngles, lastMouse, Time.deltaTime * mainSpeed);
        ...
        { //If player wants to move on X and Z axis only
            transform.position = Vector3.Lerp(transform.position, transform.position + p, Time.deltaTime * mainSpeed);
